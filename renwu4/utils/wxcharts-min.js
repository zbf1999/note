...
function calRotateTranslate(t, e, i) {
  ...
  return (
    (o *= -1), { transX: o, transY: (i - n) * (Math.sqrt(2) - 1) - (i - n - a) / Math.sqrt(2) }
  );
}
function createCurveControlPoints(t, e) {
  ...
  if (
    (e < 1
      ? ((a = t[0].x + 0.2 * (t[1].x - t[0].x)), (n = t[0].y + 0.2 * (t[1].y - t[0].y)))
    ...
    (o = t[e + 1].x - 0.2 * (t[e + 2].x - t[e].x)), (r = t[e + 1].y - 0.2 * (t[e + 2].y - t[e].y));
  return (
    i(t, e + 1) && (r = t[e + 1].y),
    i(t, e) && (n = t[e].y),
    ...
    e.angleList
      ...
      .forEach(function(t, e) {
        var i = o(t - a / 2),
          s = o(t + a / 2);
        s < i && (s += 2 * Math.PI),
          ((r >= i && r <= s) || (r + 2 * Math.PI >= i && r + 2 * Math.PI <= s)) && (n = e);
      });
  }
  return n;
}
  ...
  e.x - Math.abs(i._scrollDistance_) + 8 + s > i.width && (o = !0),
    ...
    t.forEach(function(t, i) {
      ...
      var r = e.x + 8 + 2 * a.toolTipPadding,
        l =
          e.y + (a.toolTipLineHeight - a.fontSize) / 2 + a.toolTipLineHeight * i + a.toolTipPadding;
...
function drawXAxis(t, e, i, a) {
  ...
  a.save(),
    e._scrollDistance_ && 0 !== e._scrollDistance_ && a.translate(e._scrollDistance_, 0),
    a.beginPath(),
...
function drawPieDataPoints(t, e, i, a) {
  ...
  var r = { x: e.width / 2, y: (e.height - i.legendHeight) / 2 },
    s = Math.min(
      r.x - i.pieChartLinePadding - i.pieChartTextPadding - i._pieTextMaxLength_,
  ...
  return (
    1 === n && 'ring' === e.type && drawRingTitle(e, i, a), { center: r, radius: s, series: t }
  );
}
  ...
  var e = (function() {
    ...
    a = function(n) {
      if (null === n || !0 === this.isStop)
        return t.onProcess && t.onProcess(1), void (t.onAnimationFinish && t.onAnimationFinish());
  ...
  util = {
    ...
    isCollision: function(t, e) {
      return (
        ...
        !(e.start.x > t.end.x || e.end.x < t.start.x || e.end.y > t.start.y || e.start.y < t.end.y)
      );
    },
  },
  Timing = {
